...
### почему могло «хуево вставляться»:
1. **лишние кавычки:** если ты копировал мой прошлый ответ вместе с тройными кавычками ``` в начале, markdown подумал, что это код внутри кода, и всё поплыло.
2. **отступы:** в секции с командами (типа `git clone`) важно, чтобы перед ними не было лишних пробелов.
3. **превью:** гитхаб иногда тупит в режиме редактирования. нажми вкладку **preview**, чтобы увидеть, как оно будет реально выглядеть.

**теперь нормально отображается? если нет — скажи, какая именно часть выглядит криво, поправим.**
